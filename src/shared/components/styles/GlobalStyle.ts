...
import regularFont from '@shared/assets/fonts/NotoSansKR-Regular.ttf';
import mediumFont from '@shared/assets/fonts/NotoSansKR-Medium.ttf';
import boldFont from '@shared/assets/fonts/NotoSansKR-Bold.ttf';
